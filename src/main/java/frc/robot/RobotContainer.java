...
import frc.robot.subsystems.algaeIntake.AlgaeIntakeIO_Real;
import frc.robot.subsystems.algaeIntake.AlgaeIntakeIO_Sim;
    ...
    controller
        ...
        .onTrue(
            Commands.sequence(
                ...
                algaeIntake.changeWheelsSetpoint(AlgaeWheelsSetpoint.kIntake)))
        .onFalse(
            Commands.sequence(
